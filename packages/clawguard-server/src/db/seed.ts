 ...
 *   SUPERADMIN_EMAIL      – Admin email (default: admin@clawguard.local)
 *   SUPERADMIN_PASSWORD   – Admin password (default: clawguard)
...
const DATABASE_URL = process.env.DATABASE_URL ?? "postgresql://postgres:postgres@localhost:5432/clawguard";
const SUPERADMIN_EMAIL = process.env.SUPERADMIN_EMAIL ?? "admin@clawguard.local";
const SUPERADMIN_PASSWORD = process.env.SUPERADMIN_PASSWORD ?? "clawguard";
